...
abstract class AppLocalizations {
  ...
  /// No description provided for @settingsLanguagesEnglishTitle.
  ///
  /// In en, this message translates to:
  /// **'English'**
  String get settingsLanguagesEnglishTitle;

  /// No description provided for @settingsLanguagesArabicTitle.
  ///
  /// In en, this message translates to:
  /// **'Arabic'**
